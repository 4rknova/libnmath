...
class Vector4
{
    public:
        ...
        inline void refract(const Vector4 &normal, real_t ior_src, real_t ior_dst);
        inline Vector4 refracted(const Vector4 &normal, real_t ior_src, real_t ior_dst) const;
